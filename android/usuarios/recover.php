        ...
        if ($columna = $resul->fetch(PDO::FETCH_ASSOC)) {
            ...
            $cuerpo =
                "Si desea restablecer la contraseña del usuario {$columna['nombre']} {$columna['apellidos']},
                    pulse en el siguiente enlace: <a href='https://alquilercoches.es/archivosComunes/restablecerPassword.php?usuario=" . password_hash($email, PASSWORD_DEFAULT) . "'>Restablecer contraseña</a>";
